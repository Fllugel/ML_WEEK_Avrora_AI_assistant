...
Твоє завдання: Надати чіткий перелік обраних товарів, назва має бути скороченою і не місити артикул, разом з їх ціною та кількістю товарів. Надай відповідь у формі легкої для розуміння рекомендації. 
