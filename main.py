...
- Якщо пишеш назву товару не пиши такі деталі як розмір, вага. Пиши лише назву товару. І коли необхідно кількість на в магазині.
  ...
  ВІДПОВІДАЙ В ПРОСТОМУ РОЗМОВНОМУ СТИЛІ. ЯКЩО ПИШИШ НАЗВУ ТОВАРУ ПИШИ ЯК БИ ЦЕ КАЗАЛИ ЛЮДИ.
"""
